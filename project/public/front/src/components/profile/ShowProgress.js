...
export default function ShowProgress({ data, currentPoints, setVisible }) {
    function getCoupon(level, check) {
        ...
        if (!check) {
            ...
            axios
                .post("http://localhost:8000/api/GetCoupon", form)
                        ...
                        <button
                            onClick={() =>
                                getCoupon(
                                    750,
                                    data?.points <= 750 ||
                                        data?.point_level[1].used
                                )
                            }
                            disabled={
                                data?.points <= 750 || data?.point_level[1].used
                            }
                            className="get-button"
                        >
                            GET
                        ...
                        <button
                            onClick={() =>
                                getCoupon(
                                    1000,
                                    data?.points <= 1000 ||
                                        data?.point_level[2].used
                                )
                            }
                            disabled={
                                data.points <= 1000 || data.point_level[2].used
                            }
                            className="get-button"
                        >
                            GET
                        ...
                        <button
                            onClick={() =>
                                getCoupon(
                                    1500,
                                    data?.points <= 1500 ||
                                        data?.point_level[3].used
                                )
                            }
                            disabled={
                                data.points <= 1500 || data.point_level[3].used
                            }
                            className="get-button"
                        >
                            GET
                        ...
                        <button
                            onClick={() =>
                                getCoupon(
                                    2000,
                                    data?.points <= 2000 ||
                                        data?.point_level[4].used
                                )
                            }
                            disabled={
                                data.points <= 2000 || data.point_level[4].used
                            }
                            className="get-button"
                        >
                            GET
                        ...
                        <button
                            onClick={() =>
                                getCoupon(
                                    4000,
                                    data?.points <= 4000 ||
                                        data?.point_level[5].used
                                )
                            }
                            disabled={
                                data.points <= 4000 || data.point_level[5].used
                            }
                            className="get-button"
                        >
                            GET
                        ...
                        <button
                            onClick={() =>
                                getCoupon(
                                    5000,
                                    data?.points <= 5000 ||
                                        data?.point_level[6].used
                                )
                            }
                            disabled={
                                data.points <= 5000 || data.point_level[6].used
                            }
                            className="get-button"
                        >
                            GET
                        ...
                        <button
                            onClick={() =>
                                getCoupon(
                                    10000,
                                    data?.points <= 10000 ||
                                        data?.point_level[7].used
                                )
                            }
                            disabled={
                                data.points <= 10000 || data.point_level[7].used
                            }
                            className="get-button"
                        >
                            GET
                        ...
                        <button
                            onClick={() =>
                                getCoupon(
                                    20000,
                                    data?.points <= 20000 ||
                                        data?.point_level[8].used
                                )
                            }
                            disabled={
                                data.points <= 20000 || data.point_level[8].used
                            }
                            className="get-button"
                        >
                            GET
                        ...
                        <button
                            onClick={() =>
                                getCoupon(
                                    50000,
                                    data?.points <= 50000 ||
                                        data?.point_level[9].used
                                )
                            }
                            disabled={
                                data.points <= 50000 || data.point_level[9].used
                            }
                            className="get-button"
                        >
                            GET
