  ...
  return (
    <div  className='DashbordMain  ' >
        ...
        <Routes>
            ...
            <Route path='/AjouterProduit' element={ <React.Suspense  fallback={<Loading/>}><AddProduct/></React.Suspense> } />
            <Route path='/produitmodifier/:id' element={<ModifierProduit/>} />
            <Route path='/AjouterCategorie' element={<AddCategorie/>} />
            <Route path='/Categoriemodifier/:id' element={<ModifierCategorie/>} />
            <Route path='/AjouterBrand' element={<AddBrand/>} />
            <Route path='/Brandmodifier/:id' element={<ModifierBrand/>} />
            <Route path='/AjouterOption' element={<AjouterSpect/>} />
            <Route path='/OptionModifier/:id' element={<ModifierSpect/>} />
