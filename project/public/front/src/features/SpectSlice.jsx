...
export const AddSpect = createAsyncThunk("addSpect", async (data) => {
    ...
    return axios
        .post("http://localhost:8000/api/spect", form)
        .then((res) => res.data)
        .catch((err) => console.log(err));
});
export const UpdateSpect = createAsyncThunk(
    ...
    async (data, handel) => {
        ...
        return axios
            .post("http://localhost:8000/api/spect/" + data.id, form)
            .then((res) => res.data)
